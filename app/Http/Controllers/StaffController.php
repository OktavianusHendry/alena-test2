...
class StaffController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Mengirimkan data ke view 'staff.dashboard'
        return view('staff.dashboard', compact('arsips', 'id_jenjang', 'id_kategori', 'id_sub_kategori', 'search', 'jenjangs', 'kategoris', 'sub_kategoris'));
    }
}
