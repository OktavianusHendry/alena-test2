                ...
                <div class="card mb-4">
                    <div class="container">
                        <div class="d-flex justify-content-between mb-3">
                            <a href="<?php echo e(route('arsip_pembelajaran.create')); ?>">
                        ...
                        <form action="<?php echo e(route('arsip_pembelajaran.index')); ?>" method="GET" class="mb-1">
                            <div class="row">
                        ...
                        <?php if($arsips->count() > 0): ?>
                                    ...
                                    <tbody class="table-border-bottom-0 align-content-center">
                                        <?php $__currentLoopData = $arsips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $arsip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e($arsip->judul_pembelajaran); ?></td>
                                                <td><?php echo e($arsip->jenjang->nama_jenjang); ?></td>
                                                <td><?php echo e($arsip->kelas); ?></td>
                                                <td><?php echo e($arsip->kategori->nama_kategori); ?></td>
                                                <td><?php echo e($arsip->sub_kategori->nama_sub_kategori); ?></td>
                                                <td>
                                                    <a href="<?php echo e(route('arsip_pembelajaran.show', $arsip->id_arsip_pembelajaran)); ?>"
                                                        class="btn btn-info btn-sm">Detail</a>&nbsp;&nbsp;
                                                    <a href="<?php echo e(route('arsip_pembelajaran.edit', $arsip->id_arsip_pembelajaran)); ?>"
                                                    ...
                                                    &nbsp;&nbsp;
                                                    <form
                                                        action="<?php echo e(route('arsip_pembelajaran.destroy', $arsip->id_arsip_pembelajaran)); ?>"
                            ...
                            <div class="d-flex justify-content-center my-4 pagination-wrapper">
                                <?php echo e($arsips->appends(['search' => request()->input('search')])->links('pagination::bootstrap-4')); ?>
...
<?php echo $__env->make(Auth::user()->role_as == '0' ? 'layoutsss.template' : 'layoutss.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\manajemen-kantor\resources\views/arsip_pembelajaran/index.blade.php ENDPATH**/ ?>