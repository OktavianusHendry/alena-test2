                    ...
                    <div class="col-xl">
                        <div class="col-xl">
                            <div class="card mb-4">
                                ...
                                <form action="<?php echo e(route('unit_penempatan.store')); ?>" method="POST"
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <select name="id_sekolah" id="id_sekolah" class="form-control">
                                                    ...
                                                    <?php $__currentLoopData = $sekolas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($s->id_sekolah); ?>"><?php echo e($s->nama_sekolah); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <select name="id_kategori" id="id_kategori" class="form-control">
                                                    ...
                                                    <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($k->id_kategori); ?>"><?php echo e($k->nama_kategori); ?>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <select name="id_sub_kategori" id="id_sub_kategori" class="form-control">
                                                    ...
                                                    <?php $__currentLoopData = $sub_kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($t->id_sub_kategori); ?>">
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\manajemen-kantor\resources\views/unit_penempatan/create.blade.php ENDPATH**/ ?>