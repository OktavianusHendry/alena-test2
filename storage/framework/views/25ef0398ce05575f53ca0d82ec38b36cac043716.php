                ...
                <div class="card mb-4">
                    <div class="container">
                        <div class="d-flex justify-content-between mb-3">
                            <a href="<?php echo e(route('tujuan.create')); ?>">
                        ...
                        <form action="<?php echo e(route('tujuan.index')); ?>" method="GET" class="mb-3">
                        ...
                        <?php if($tujuans->count() > 0): ?>
                                    ...
                                    <tbody class="table-border-bottom-0 align-content-center">
                                        <?php $__currentLoopData = $tujuans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tujuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><i class="fab fa-angular fa-lg text-danger me-3"></i>
                                                    <strong><?php echo e($tujuan->nama_tujuan); ?></strong>
                                                </td>
                                                <td>
                                                    <a href="<?php echo e(route('tujuan.edit', $tujuan->id_tujuan)); ?>"
                                                        class="btn btn-warning btn-sm">&nbsp;
                                                        <i class="menu-icon tf-icons bx bx-edit"></i>
                                                    </a>&nbsp;&nbsp;
                                                    <form action="<?php echo e(route('tujuan.destroy', $tujuan->id_tujuan)); ?>"
                            ...
                            <div class="d-flex justify-content-center my-4 pagination-wrapper">
                                <?php echo e($tujuans->appends(['search' => request()->input('search')])->links('pagination::bootstrap-4')); ?>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\manajemen-kantor\resources\views/tujuan/index.blade.php ENDPATH**/ ?>