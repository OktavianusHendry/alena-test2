                                ...
                                <div class="table-responsive text-nowrap">
                                    <div class="row mb-3">
                                        <div class="col-sm-6">
                                            ...
                                            <p><?php echo e($unitPenempatan->user->name); ?></p>
                                        </div>
                                        <div class="col-sm-6">
                                            <label class="form-label"><strong>Mentoring di Sekolah:</strong></label>
                                            <p><?php echo e($unitPenempatan->sekolah->nama_sekolah); ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-6">
                                            ...
                                            <p><?php echo e($unitPenempatan->kategori->nama_kategori); ?></p>
                                        </div>
                                        <div class="col-sm-6">
                                            <label class="form-label"><strong>Sub Kategori:</strong></label>
                                            <p><?php echo e($unitPenempatan->sub_kategori->nama_sub_kategori); ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-6">
                                            ...
                                            <p><?php echo e($unitPenempatan->kelas); ?></p>
                                        </div>
                                        <div class="col-sm-6">
                                            <label class="form-label"><strong>Jumlah Anak yang diajar:</strong></label>
                                            <p><?php echo e($unitPenempatan->jumlah_anak); ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-6">
                                            ...
                                            <p><?php echo e($unitPenempatan->jumlah_pertemuan); ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-6">
                                            ...
                                            <p><?php echo e($unitPenempatan->mulai_tanggal); ?></p>
                                        </div>
                                        <div class="col-sm-6">
                                            <label class="form-label"><strong>Sampai Tanggal:</strong></label>
                                            <p><?php echo e($unitPenempatan->sampai_tanggal); ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <p class="detail-paragraph"><?php echo e($unitPenempatan->detail); ?></p>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        <!-- Tombol Kembali -->
                                        <a href="<?php echo e(route('unit_penempatan.index')); ?>"
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body text-center mt-3">
                                <img class="img-fluid mb-3"
                                    src="<?php echo e(asset('storage/' . $unitPenempatan->user->foto_diri)); ?>" alt="Foto Diri">
                                <p><?php echo e($unitPenempatan->user->name); ?></p>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\manajemen-kantor\resources\views/unit_penempatan/show.blade.php ENDPATH**/ ?>