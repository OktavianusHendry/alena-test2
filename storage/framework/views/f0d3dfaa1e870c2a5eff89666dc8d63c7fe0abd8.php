                    ...
                    <div class="container">
                        <div class="d-flex justify-content-between mb-3">
                            <?php if(Auth::user()->role_as == '2'): ?>
                                <a href="<?php echo e(route('laporan_cuti.create')); ?>">
                        ...
                        <form action="<?php echo e(route('laporan_cuti.index')); ?>" method="GET" class="mb-3">
                        ...
                        <?php if($laporanCuti->count() > 0): ?>
                            <div class="table-responsive text-nowrap">
                                ...
                                <table class="table table-hover align-content-center">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $laporanCuti; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cuti): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($loop->iteration); ?></td>
                                                <td><?php echo e($cuti->users->name); ?></td>
                                                <td><?php echo e($cuti->divisi->kode_divisi ?? 'Tidak tersedia'); ?></td>
                                                <td>
                                                    <?php if($cuti->status == 'approved'): ?>
                                                    ...
                                                    <?php elseif($cuti->status == 'pending'): ?>
                                                        <?php if(Auth::user()->role_as == 1): ?>
                                                            <!-- Tombol Disetujui -->
                                                            <button class="btn btn-success btn-sm"
                                                                onclick="ubahStatus('<?php echo e($cuti->cuti_id); ?>', 'approved')">Setujui</button>

                                                            <!-- Tombol Ditolak (memicu modal) -->
                                                            <button class="btn btn-danger btn-sm"
                                                                onclick="showRejectModal('<?php echo e($cuti->cuti_id); ?>')">Tolak</button>
                                                        <?php else: ?>
                                                ...
                                                <td>
                                                    <?php if($cuti->status == 'rejected'): ?>
                                                        <?php echo e($cuti->catatan); ?>
                                                ...
                                                <td>
                                                    <?php if(Auth::user()->role_as == '2' && $cuti->status == 'approved'): ?>
                                                        <button class="btn btn-primary btn-sm"
                                                            onclick="printCuti('<?php echo e($cuti->cuti_id); ?>')">
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="exampleModalLabel2">
                                                                        <b><?php echo e($cuti->users->name); ?></b>
                                                                    </h5>
                                                                    <button type="button" class="btn-close"
                                                                ...
                                                                <div class="modal-body">
                                                                    <hr>
                                                                    Divisi:
                                                                    <?php echo e($cuti->divisi->kode_divisi ?? 'Tidak tersedia'); ?><br>
                                                                    <hr>
                                                                    Jenis Cuti:
                                                                    <?php echo e($cuti->jenis_cuti->nama_jenis_cuti); ?><br>
                                                                    <hr>
                                                                    Mulai: <?php echo e($cuti->mulai_tanggal); ?><br>
                                                                    <hr>
                                                                    Sampai: <?php echo e($cuti->sampai_tanggal); ?><br>
                                                                    <hr>
                                                                    Alasan: <?php echo e($cuti->keterangan); ?><br>
                                                                    <hr>
                                                                    Status: <?php echo e($cuti->status); ?><br>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button"
                                                    ...
                                                    <form action="<?php echo e(route('laporan_cuti.destroy', $cuti->cuti_id)); ?>"
                            ...
                            <div class="d-flex justify-content-center my-4 pagination-wrapper">
                                <?php echo e($laporanCuti->appends(['search' => request()->input('search')])->links('pagination::bootstrap-4')); ?>
...
<?php echo $__env->make(Auth::user()->role_as == 1 ? 'layouts.template' : 'layoutss.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\manajemen-kantor\resources\views/laporan_cuti/index.blade.php ENDPATH**/ ?>