            ...
            <main class="py-4">
                ...
                <div class="card mb-4">
                    <div class="container">
                        ...
                        <form action="<?php echo e(route('kategori.index')); ?>" method="GET" class="mb-3">
                        ...
                        <?php if($kategoris->count() > 0): ?>
                                    ...
                                    <tbody class="table-border-bottom-0 align-content-center">
                                        <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo e(route('kategori.edit', $kategori->id_kategori)); ?>"
                                                        class="btn btn-warning btn-sm">&nbsp;
                                                        <i class="menu-icon tf-icons bx bx-edit"></i>
                                                    </a>&nbsp;&nbsp;
                                                    <form action="<?php echo e(route('kategori.destroy', $kategori->id_kategori)); ?>"
                            ...
                            <div class="d-flex justify-content-center my-4 pagination-wrapper">
                                <?php echo e($kategoris->appends(['search' => request()->input('search')])->links('pagination::bootstrap-4')); ?>
...
<?php echo $__env->make(Auth::user()->role_as == '1' ? 'layouts.template' : 'layoutss.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\manajemen-kantor\resources\views/kategori/index.blade.php ENDPATH**/ ?>