            ...
            <main class="py-4">
                ...
                <div class="card mb-4">
                    <div class="container">
                        ...
                        <form action="<?php echo e(route('jabatan.index')); ?>" method="GET" class="mb-3">
                        ...
                        <?php if($jabatans->count() > 0): ?>
                                    ...
                                    <tbody class="table-border-bottom-0 align-content-center">
                                        <?php $__currentLoopData = $jabatans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jabatan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><i class="fab fa-angular fa-lg text-danger me-3"></i>
                                                    <strong><?php echo e($jabatan->nama_jabatan); ?></strong>
                                                </td>
                                                <td>
                                                    <a href="<?php echo e(route('jabatan.edit', $jabatan->id_jabatan)); ?>"
                                                        class="btn btn-warning btn-sm">&nbsp;
                                                        <i class="menu-icon tf-icons bx bx-edit"></i>
                                                    </a>&nbsp;&nbsp;
                                                    <form action="<?php echo e(route('jabatan.destroy', $jabatan->id_jabatan)); ?>"
                            ...
                            <div class="d-flex justify-content-center my-4 pagination-wrapper">
                                <?php echo e($jabatans->appends(['search' => request()->input('search')])->links('pagination::bootstrap-4')); ?>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\manajemen-kantor\resources\views/jabatan/index.blade.php ENDPATH**/ ?>