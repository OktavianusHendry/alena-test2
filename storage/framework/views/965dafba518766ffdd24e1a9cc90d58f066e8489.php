                ...
                <div class="card mb-4">
                    <div class="container">
                        <div class="d-flex justify-content-between mb-3">
                            <a href="<?php echo e(route('instansi.create')); ?>">
                        ...
                        <form action="<?php echo e(route('instansi.index')); ?>" method="GET" class="mb-3">
                        ...
                        <?php if($instansis->count() > 0): ?>
                                    ...
                                    <tbody class="table-border-bottom-0 align-content-center">
                                        <?php $__currentLoopData = $instansis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $instansi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><i class="fab fa-angular fa-lg text-danger me-3"></i>
                                                    <strong><?php echo e($instansi->nama_instansi); ?></strong>
                                                </td>
                                                <td><i class="fab fa-angular fa-lg text-danger me-3"></i>
                                                    <strong><?php echo e($instansi->tujuan->nama_tujuan); ?></strong>
                                                </td>
                                                <td>
                                                    <a href="<?php echo e(route('instansi.show', $instansi->id_instansi)); ?>"
                                                        class="btn btn-info btn-sm">
                                                        &nbsp;<i
                                                            class="menu-icon tf-icons bx bxs-detail"></i></a>&nbsp;&nbsp;
                                                    <a href="<?php echo e(route('instansi.edit', $instansi->id_instansi)); ?>"
                                                        class="btn btn-warning btn-sm">
                                                        &nbsp;<i class="menu-icon tf-icons bx bx-edit"></i>
                                                    </a>&nbsp;&nbsp;
                                                    <form action="<?php echo e(route('instansi.destroy', $instansi->id_instansi)); ?>"
                            ...
                            <div class="d-flex justify-content-center my-4 pagination-wrapper">
                                <?php echo e($instansis->appends(['search' => request()->input('search')])->links('pagination::bootstrap-4')); ?>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\manajemen-kantor\resources\views/instansi/index.blade.php ENDPATH**/ ?>